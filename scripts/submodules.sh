...
git submodule add -b master https://$GHUSERNAME:$GHAPIKEY@github.com/ch-lukas/adminjs-design-system.git packages/adminjs-design-system
...
git submodule add -b master https://$GHUSERNAME:$GHAPIKEY@github.com/ch-lukas/adminjs-mongoose.git packages/adminjs-mongoose
...
git submodule add -b master https://$GHUSERNAME:$GHAPIKEY@github.com/ch-lukas/adminjs-example-app.git adminjs-example-app
